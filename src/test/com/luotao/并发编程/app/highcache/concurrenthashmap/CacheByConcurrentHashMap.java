package test.com.luotao.并发编程.app.highcache.concurrenthashmap;
 ...
 * @author LuoTao
 */
public class CacheByConcurrentHashMap<K,V> implements Computable<K,V> {
    /**
    ...
    **/
    ...
    public CacheByConcurrentHashMap(Computable<K,V> myComputer) {
    ...
    **/
    ...
    public static void main(String[] args) throws Exception {
        CacheByConcurrentHashMap<String,Integer> cache = new CacheByConcurrentHashMap(new Computer());
